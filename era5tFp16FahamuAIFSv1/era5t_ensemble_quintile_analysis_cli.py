#!/usr/bin/env python3
"""
ERA5T Ensemble Quintile Analysis - For ERA5T-based AIFS forecasts
=================================================================

Usage:
    python era5t_ensemble_quintile_analysis_cli.py --date 20260305 --members 0-9
...
GCS Path Structure:
    Default: gs://bucket/{date}_0000/era5t_fp16_1p5deg_nc/
"""
...
def download_ensemble_nc_from_gcs_chunked(
    ...
    if gcs_prefix is None:
        if fp16:
            gcs_prefix = f"{forecast_date}_0000/era5t_fp16_1p5deg_nc/"
        else:
            gcs_prefix = f"{forecast_date}_0000/era5t_1p5deg_nc/"
...
def load_ensemble_from_gcs(
    ...
    Args:
        ...
        gcs_prefix: Custom GCS prefix (overrides auto-generated path)
...
def main():
    parser = argparse.ArgumentParser(
        description="ERA5T Ensemble Quintile Analysis",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
GCS Path Structure (ERA5T):
    FP32: gs://bucket/{date}_0000/era5t_1p5deg_nc/
    FP16: gs://bucket/{date}_0000/era5t_fp16_1p5deg_nc/

Examples:
    # ERA5T FP16 forecasts (10 members)
    python era5t_ensemble_quintile_analysis_cli.py --date 20260305 --fp16 --members 0-9
    ...
    parser.add_argument('--gcs-prefix', default=None,
                       help='Custom GCS prefix (overrides auto-generated path)')
    ...
    if args.fp16:
        output_file = os.path.join(args.output_dir,
                                   f'era5t_ensemble_quintile_probabilities_{forecast_date}_fp16.nc')
    else:
        output_file = os.path.join(args.output_dir,
                                   f'era5t_ensemble_quintile_probabilities_{forecast_date}.nc')
